...
func (s *Server) routes() {
	...
	s.mux.HandleFunc("GET /admin/generations", s.requireAdmin(s.getAdminGenerations))
	s.mux.HandleFunc("POST /admin/generations", s.requireAdmin(s.postAdminGeneration))
	s.mux.HandleFunc("GET /admin/generations/status", s.requireAdmin(s.getAdminGenerationStatus))
	s.mux.HandleFunc("GET /admin/generations/{run}", s.requireAdmin(s.getAdminGenerationRun))
	s.mux.HandleFunc("GET /admin/users/{user}/problems", s.requireAdmin(s.getAdminUserProblems))
